...
import com.U_line.page.actions.web.Retailer.Product_Registration_page;
import com.U_line.page.validators.web.LoginValidator;
import com.U_line.tests.web.Servicer.Servicer_HomePage_Test;
...
public class Product_registration_test extends BaseConfiguration {
    ...
    private com.U_line.page.actions.web.Retailer.Product_Registration_page homePageActions;
    ...
    @Test(priority = 5, testName = "TC_PR_06", description = "To validate the functionality of Purchase Info with black field")
    ...
    @Test(priority = 8, testName = "TC_PR_07", description = "To validate the functionality of Purchase Info with valid data ")
    public void Purchase_info_with_upload() throws InterruptedException {
        homePageActions.Purchase_info_valid_with_upload();

    }

    @Test(priority = 9, testName = "TC_PR_09", description = "To validate the functionality of Owner Contact Info with blanck field")
    public void Customer_info_blank() throws InterruptedException {
        homePageActions.Owner_contact_Info_Blank();

    }

    @Test(priority = 11, testName = "TC_PR_10", description = "To validate the functionality of Owner Contact Info with invalid data ")
    public void Customer_info_invalid() throws InterruptedException {
        homePageActions.Owner_contact_Info_Invalid();

    }

    @Test(priority = 12, testName = "TC_PR_11", description = "To validate the functionality of Owner Contact Info with valid data ")
