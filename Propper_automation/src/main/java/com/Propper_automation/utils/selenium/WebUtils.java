package com.Propper_automation.utils.selenium;



import static com.Propper_automation.utils.common.Constants.LOG_DESIGN;
...
public class WebUtils {
	...
	public static String getSelectedValueInDropDown(WebElement element) {
		...
		LOGGER.info("Selected value from dropdown [{}] , is [{}]", selectedValueFromDropdown);
		return selectedValueFromDropdown;
	}
	public static void select_textbox(WebElement element) {
	...
	public static void SwitchTowindopopup() throws InterruptedException {
