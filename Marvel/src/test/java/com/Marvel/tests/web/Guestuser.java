...
import com.Marvel.page.actions.web.Guesthome;
...
public class Guestuser extends BaseConfiguration{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(Guestuser.class);
		...
		public void Validate_shipping_Info() throws InterruptedException {
			...
			homePageActions.LastName();
			homePageActions.streetaddress();
			homePageActions.Companyname();
			homePageActions.City();
			homePageActions.State();
			homePageActions.zipcode();
			homePageActions.phonenumber();
