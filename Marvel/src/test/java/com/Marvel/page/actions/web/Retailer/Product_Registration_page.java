...
public class Product_Registration_page {
    ...
    public void Product_Registration() throws InterruptedException {
        ...
        WebElement ele1= driver.findElement(By.xpath("//a[contains(text(),'Warranty Registration')]"));
        ele1.click();
    }
    ...
    public void Serial_number_valid() throws InterruptedException {
        ...
        Serial_number.sendKeys("20191216057H");
        Thread.sleep(6000);
        Next_button.click();
    }
    ...
    public void Purchase_info_blank() throws InterruptedException {
        ...
        Thread.sleep(4000);
      WebElement ele= driver.findElement(By.xpath("//button[@id='step3']"));
      ele.click();
    }
    ...
    public void Purchase_info_valid_with_checkbox() throws InterruptedException {
        ...
        Checkbox.click();
        WebElement ele2= driver.findElement(By.xpath("//button[@id='step3']"));
        ele2.click();
...
//
        Checkbox.click();
//        WebElement ele3= driver.findElement(By.xpath("//button[@id='step3']"));
//        ele3.click();
    }
    ...
    public void Owner_contact_Info_valid () throws InterruptedException {
        ...
        Phone_number.sendKeys("9456789876");
        ...
        State.sendKeys("missouri");
        WebElement ele1 = driver.findElement(By.xpath("//select[@name='country']"));
